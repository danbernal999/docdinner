    ...
    <div class="">
      <table class="w-full text-md table-auto md:table-fixed">
        ...
        <?php foreach ($result as $row): ?>
          ...
          <!-- Modal para eliminar la meta -->
          <!-- <div id="confirmDeleteModal<?= $row['id'] ?>" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm">
              <h2 class="text-xl font-semibold text-red-600 mb-4">¿Eliminar Meta?</h2>
              <p class="text-neutral-800 mb-6">¿Estás seguro de que deseas eliminar esta meta de ahorro?</p>
              <div class="flex justify-end space-x-2">
                <button onclick="closeDeleteModal()" class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400">Cancelar</button>
                <a id="confirmDeleteBtn" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Eliminar</a>
              </div>
            </div>
          </div> -->
